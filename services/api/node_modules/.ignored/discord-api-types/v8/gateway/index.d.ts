...
import type { APIChannel, APIEmoji, APIGuild, APIGuildMember, APIMessage, APIRole, APIUnavailableGuild, APIUser, GatewayActivity, GatewayPresenceUpdate as RawGatewayPresenceUpdate, GatewayVoiceState, InviteTargetUserType, PresenceUpdateStatus, APIApplicationCommandInteraction, APIApplication } from '../payloads/index';
 ...
 * https://discord.com/developers/docs/topics/gateway#guild-member-update
 */
export declare type GatewayGuildMemberUpdateDispatchData = Omit<APIGuildMember, 'deaf' | 'mute'> & {
    /**
     * The id of the guild
     */
    guild_id: Snowflake;
