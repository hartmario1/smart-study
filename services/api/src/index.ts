...
import { createApp, Route } from '@smartstudy/rest';
import { readdirRecurse } from '@gaius-bot/readdir';
import { join as joinPath } from 'path';
import { container } from 'tsyringe';
import createLogger from '@smartstudy/logger';
import postgres from 'postgres';
import Stripe from 'stripe';
import { initConfig, kLogger, kSql, kStripe, kRedis } from '@smartstudy/injection';
