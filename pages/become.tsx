...
import { FaInstagram, FaTwitter, FaUniversity } from 'react-icons/fa'
            ...
            <Box
              ...
              <Flex p={4}>
                <Wrap spacing={{ base: 20, sm: 3, md: 5, lg: 20 }} justify="center">
                  <WrapItem paddingX="6" paddingTop="6" alignItems="center">
                    <Center flexDir={'column'}>
                      <Heading>Contact us</Heading>
                      <Text mt={{ sm: 3, md: 3, lg: 5 }} color="gray.500">
                        Fill up the form and get ready<br />to become a part of our team.
                      </Text>
                      <Box py={{ base: 5, sm: 5, md: 8, lg: 10 }}>
                        <VStack pl={0} spacing={3} alignItems="flex-start">
                          <Button
                            ...
                            variant="ghost"
                            color="purple"
                            _hover={{ border: '2px solid #6366f1' }}
                            leftIcon={<MdEmail color="#6366f1" size="20px" />}>
                            smartstudy@office.at
                          </Button>
                          <Button
                            size="md"
                            height="48px"
                            ...
                            color="purple"
                            _hover={{ border: '2px solid #6366f1' }}
                            leftIcon={<MdLocationOn color="#6366f1" size="20px" />}>
                            Wien, Austria
                          </Button>
                        </VStack>
                      </Box>
                      ...
                      <Box m={6} color="#0B0E3F">
                        <Flex direction={['column']}>
                          <Flex direction={{ base: 'column', md: 'row' }}>
                            <FormControl id="name" paddingRight={{ base: "0", md:"1" }}>
                              <FormLabel>Name</FormLabel>
                              <InputGroup borderColor="#E0E1E7">
                                <InputLeftElement pointerEvents="none">
                                  <BsPerson color="gray.800" />
                                </InputLeftElement>
                                <Input focusBorderColor='purple' type="text" size="md" />
                              </InputGroup>
                            </FormControl>
                            <FormControl id="email" paddingTop={{ base: "5", md:"0" }} paddingLeft={{ base: "0", md:"1" }}>
                          ...
                          <FormControl paddingTop="5">
                            <FormLabel>Course</FormLabel>
                              ...
                              placeholder="What course would you like to teach?"
                            />                            
                          </FormControl>
                          <FormControl paddingTop="5">
                            ...
                            <Textarea
                              ...
                              placeholder="Why would you like to become a tutor?"
                            />
                          </FormControl>
                          <FormControl id="name" paddingTop="5">
                            <Button variant="solid" bg="purple" color="white" _hover={{}}>
                              Send Message
                            </Button>
                          </FormControl>
                        </Flex>
